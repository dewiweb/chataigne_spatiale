...
save_path = input("Where do you want to write the file?(choose a valid path): ")

while not os.path.exists(save_path):
    print ('invalid path')
    save_path = input("Where do you want to write the file?(choose a valid path): ")
else:
    filename = input("OK! Now which name do you choose for your file(with.json extension)?")
    print("Ready,GO!")
