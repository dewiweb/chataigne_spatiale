...
var myTrigger = script.addTrigger("Browse", "Open a json external file");
var myStringParam = script.addStringParameter("Current filepath","Description of my string param", "test.json");
...
function scriptParameterChanged(param)
{
	...
	//root.sequences.getChild(lastItemName).layers.addItem();
	var filepath = myStringParam.get();
	var myTrajectory = util.readFile(filepath);
	//root.sequences.sequence3.layers.addItem("Mapping2D");
	script.log(myTrajectory);
